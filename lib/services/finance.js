...
function getMockFinancialData(ticker) {
  return {
    ...
    financialMetrics: {
      ...
      regularMarketChangePercent: ticker.toUpperCase() === 'TSLA' ? -2.15 : ticker.toUpperCase() === 'AAPL' ? 1.24 : 4.82,
      displayName: ticker.toUpperCase() === 'AAPL' ? 'Apple Inc.' : ticker.toUpperCase() === 'TSLA' ? 'Tesla Inc.' : ticker.toUpperCase() === 'NVDA' ? 'NVIDIA Corp.' : ticker
    }
  };
}
